...
from script_barebone_refinement import generate_script
from tmp import tmp_barebone_script_path

logging.basicConfig(level=logging.INFO)

def paper_2_video(arxiv_id):
    try:
    ...
    try:
        # TODO: Turn the summary into a barebone video script structure with approximated lengths of the sections
        script = generate_barbone_script(summary)
        print(script)
    ...
    try:
        # TODO: Generate a detailed summary for each section of the generated script structure
        print()
    except Exception as e:
